 ...
 * My Chatbot World — Sidebar Navigation
 *
 * 5대 메뉴:
 *   1. Birth    (탄생)    — 챗봇 생성, 성격/외형 설정, 아바타
  ...
  const MENU_DATA = [
    {
      ...
      description: '챗봇 탄생',
      children: [
        { label: '챗봇 생성', labelEn: 'Create Bot',      href: 'pages/birth/index.html#create'    },
    ...
    },
    {
      ...
      children: [
        ...
        { label: '챗봇스쿨',     labelEn: 'Chatbot School',   href: 'pages/learning/index.html#school'     },
    ...
    },
    {
      ...
      children: [
        ...
        { label: '챗봇 간 협업', labelEn: 'Collaborate', href: 'pages/community/index.html#collab'   },
