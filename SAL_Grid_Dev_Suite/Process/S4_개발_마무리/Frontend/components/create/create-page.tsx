/**
 * @task S2FE1 / S4GA1
 * @description Create 위저드 페이지 — 5단계 챗봇 생성 스텝퍼
 *
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 진행 표시바 — Step 0은 표시하되 1-based로 렌더 */}
        <WizardProgressBar currentStep={step + 1} totalSteps={TOTAL_STEPS} />
...
const STEP_META: Record<number, { title: string; description: string }> = {
  0: {
    title: '템플릿 선택',
    description: '업종에 맞는 템플릿을 선택하거나 직접 처음부터 만드세요.',
  },
  1: {
    title: '기본 정보 입력',
