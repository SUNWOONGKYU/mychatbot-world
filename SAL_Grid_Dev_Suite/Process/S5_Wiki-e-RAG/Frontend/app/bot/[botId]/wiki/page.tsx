...
export default function WikiManagePage() {
  ...
  const TYPE_BADGE: Record<string, string> = {
    ...
    auto_generated: 'bg-green-100 text-green-700',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b px-6 py-4 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-gray-900">Wiki 관리</h1>
        ...
        {!loading && (
          <div className="grid gap-3">
            ...
            {filtered.map((page) => (
              <div
                key={page.id}
                className={`bg-white rounded-lg border p-4 cursor-pointer hover:border-blue-300 transition ${
                  page.is_stale ? 'border-orange-200' : ''
                }`}
              ...
              >
                <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      <span
                        className={`px-2 py-0.5 rounded text-xs font-medium ${
                          TYPE_BADGE[page.page_type] ?? 'bg-gray-100 text-gray-600'
                        }`}
                      >
                  ...
                  <button
                    ...
                    className="ml-3 px-3 py-1.5 text-xs text-red-600 border border-red-200 rounded hover:bg-red-50 disabled:opacity-50"
                  >
        ...
        >
          ...
          >
            ...
            <div className="flex gap-2 mb-4">
              <span
                className={`px-2 py-0.5 rounded text-xs font-medium ${
                  TYPE_BADGE[selected.page_type] ?? 'bg-gray-100 text-gray-600'
                }`}
              >
            ...
            <div className="mt-4 flex justify-between items-center text-xs text-gray-400">
              ...
              <button
                ...
                className="px-3 py-1.5 text-red-600 border border-red-200 rounded hover:bg-red-50"
              >
                삭제
              </button>
            </div>
