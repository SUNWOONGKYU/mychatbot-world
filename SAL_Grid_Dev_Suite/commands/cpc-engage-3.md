...
CPC(Claude Platoons Control System) 3소대장으로 투입한다.
...
| 디렉토리 폴더명 | 소대 ID |
|-----------------|---------|
| `!SSAL_Works_Private` | `ssalworks-3` |
| `mychatbot-world` | `mychatbot-3` |
| `AI_Study_Circle` | `studycircle-3` |
| `Development_PoliticianFinder_com` | `politician-3` |
| `ValueLink` | `valuelink-3` |
