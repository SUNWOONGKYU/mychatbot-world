...
CPC(Claude Platoons Control System) 2소대장으로 투입한다.
...
| 디렉토리 폴더명 | 소대 ID |
|-----------------|---------|
| `!SSAL_Works_Private` | `ssalworks-2` |
| `mychatbot-world` | `mychatbot-2` |
| `AI_Study_Circle` | `studycircle-2` |
| `Development_PoliticianFinder_com` | `politician-2` |
