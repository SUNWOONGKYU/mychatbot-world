  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[rgb(var(--bg-base))]">
      <div className="text-center space-y-4 p-8">
        <h2 className="text-xl font-semibold text-[rgb(var(--text-primary-rgb))]">문제가 발생했습니다</h2>
        <p className="text-[rgb(var(--text-secondary-rgb))]">{error.message || '잠시 후 다시 시도해주세요.'}</p>
