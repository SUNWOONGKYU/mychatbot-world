...
const CATEGORY_LABELS: Record<string, string> = Object.fromEntries(
  CATEGORIES.filter((c: any) => c.value).map((c: any) => [c.value, c.label]),
);
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <form
          ...
          onSubmit={(e: any) => handleSubmit(e, false)}
          noValidate
        >
          {/* 스킬 이름 */}
          <FormField label="스킬 이름" required error={errors.skillName}>
            <input
              ...
              onChange={(e: any) => updateField('skillName', e.target.value)}
              autoComplete="off"
            />
          </FormField>
          ...
          >
            <textarea
              ...
              onChange={(e: any) => updateField('longDescription', e.target.value)}
            />
          </FormField>
          ...
          >
            <input
              ...
              onChange={(e: any) => updateField('botId', e.target.value)}
              autoComplete="off"
            />
          </FormField>
          ...
          <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-3 pt-2">
            ...
            <button
              ...
              onClick={(e: any) => handleSubmit(e as unknown as React.FormEvent, true)}
              className={clsx(
