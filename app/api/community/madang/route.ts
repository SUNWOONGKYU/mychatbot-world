// @task S5-FIX-F6
/**
 * Community Madang (마당) API — 마당 목록 + 인기 코코봇
 * GET /api/community/madang            — 마당 목록
 * GET /api/community/madang?popular_bots=1 — 인기 코코봇 (사이드바)
 *
...
const MADANG_LIST = [
  ...
  { id: 'showcase',   name: '자랑 마당',     emoji: '🏆', description: '내 코코봇을 자랑하세요' },
  { id: 'tips',       name: '꿀팁 마당',     emoji: '💡', description: '코코봇 운영 노하우 공유' },
