...
const SCHOOL_FEATURES = [
  { icon: '📄', title: '문서 학습', desc: 'PDF·DOCX·TXT 파일을 업로드하면 자동으로 분할·색인됩니다.' },
  { icon: '🔗', title: 'URL 학습', desc: '웹 페이지 주소를 입력하면 본문을 추출해 지식으로 축적합니다.' },
  { icon: '❓', title: 'FAQ 등록', desc: '자주 묻는 질문과 답변을 수동으로 등록해 즉시 활용합니다.' },
  { icon: '💬', title: '대화 자동 학습', desc: '사용자와의 질의응답에서 좋은 답변을 자동 평가해 위키로 축적합니다.' },
];
