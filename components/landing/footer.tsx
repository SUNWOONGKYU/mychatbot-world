  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        {/* 신뢰 배지 */}
        <div
          className="mt-10 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 border-t pt-6"
        ...
        >
          <Link
            ...
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLAnchorElement).style.color = 'rgb(var(--text-muted))';
            }}
          >
            개인정보처리방침
          </Link>
        ...
        {/* 하단 바 */}
        <div
          className="mt-6 flex flex-col items-center justify-between gap-4 border-t pt-8 sm:flex-row"
          style={{ borderColor: 'rgb(var(--border))' }}
        >
          <p
            className="text-sm"
