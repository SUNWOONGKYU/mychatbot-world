...
- 텍스트: `#111827` → **`#475569` (neutral-600)** → **`#64748B` (neutral-500)**
- 보더: **`#CBD5E1` (neutral-300)** → `#E2E8F0` → `#94A3B8`

**라이트 모드 WCAG AA 기준 (S7FE9 강화):** 흰 배경 기준 대비비
- `--text-primary` #111827 → **15.8:1** (AAA)
- `--text-secondary-rgb` #475569 → **7.2:1** (AAA)
- `--text-muted` #64748B → **4.5:1** (AA 통과)
- `--border` #CBD5E1 → UI 식별 가능

> **금지**: 라이트 모드에서 `text-muted` 이하 토큰을 본문 14px 미만에 사용 금지 (대비 부족). 메타·캡션 한정.
